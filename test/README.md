...
This directory contains comprehensive tests for the NVIDIA BMM CAPI Provider.
...
E2E tests require a real NVIDIA BMM environment and test full cluster lifecycle:

```bash
# Set environment variables
export NVIDIA_BMM_API_ENDPOINT="https://api.carbide.nvidia.com"
export NVIDIA_BMM_ORG_NAME="your-org"
export NVIDIA_BMM_API_TOKEN="your-jwt-token"
...
- Real NVIDIA BMM API integration

**⚠️ WARNING:** E2E tests create real resources in NVIDIA BMM. Ensure you have cleanup automation and understand costs.

## Test Coverage

### Unit Tests (`pkg/cloud/client_test.go`)

Tests all NVIDIA BMM API operations:
...
# Run specific test
ginkgo -focus="NvidiaBMMCluster" ./test/integration
```
...
When the NVIDIA BMM API client interface changes:
