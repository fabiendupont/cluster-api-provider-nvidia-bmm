module github.com/fabiendupont/cluster-api-provider-nvidia-bmm

go 1.25.4

require (
	github.com/NVIDIA/carbide-rest v0.0.0-00010101000000-000000000000
...
replace github.com/NVIDIA/carbide-rest => ../carbide-rest
